...
const workExp = [
  {
    ...
    details: [
      ...
      "I have been responsible for implementing the frontend, including API integrations for HL7 and FHIR patients and UI enhancements, addressing challenges as they arise.",
